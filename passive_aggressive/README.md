...
This python script visualizes the results of Online Passive-Aggressive (PA) algorithm and PA-1 algorithm.  


PA algorithm is a margin based online learning algorithm[Crammer et al.] for binary classification.  
Unlike PA which is a hard-margin based method, PA-I is a soft margin based method and robuster to noise.
