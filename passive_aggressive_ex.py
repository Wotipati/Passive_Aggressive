...
def main():
    ...
    test_dataset  = SimpleDataset(total_num=250 , is_confused=False, x=3, y=5, seed=2)
    ...
    fig_left.legend(handles=[line_PA, line_PA_one])
    fig_right.legend(handles=[line_PA, line_PA_one])
